...
It is designed as a simplified CRM system with a focus on a **beautiful UI** and a **powerful back-end**.  
...
### 🎯 Purpose
The main goal of Custra is to demonstrate skills in building a combination of a **modern front-end** and a **robust back-end** using popular technologies.  
